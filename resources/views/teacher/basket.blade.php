        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-6">
                    ...
                    <form class="form-horizontal" action="{{url('basketupdate/' . $basket->id)}}" method="post">
                ...
                <div class="col-md-4">
                    <div class="event" style="font-family: 'Open Sans', sans-serif;font-weight: 400;">
                        ...
                        <div class="info">
                            Basket Status: {{$basket->basketStatus}};
                            <br/>
                            Volunteer Numbers: 0;
                    ...
                    <div class="event" style="font-family: 'Open Sans', sans-serif;font-weight: 400;">
                        ...
                        <div class="info">
                            RESPONDERE ID: {{$basket->responderedID}} <br/>
                            Questioner ID: {{$basket->questionerID}}
                        </div>
                    </div>
                </div>
            </div>
